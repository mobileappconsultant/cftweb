  ...
  const fetchData = async (paginationArgs = pagination) => {
    ...
    if (apiData.data) {
      setState({
        ...
        activeDataObj: apiData?.data?.getAllBranch?.docs
          ? apiData?.data?.getAllBranch?.docs[0]
          : {},
        pagination: {
    ...
    members = apiData?.data?.getAllBranch?.totalDocs;
    if (!apiData.loading) {
      setState({
        isLoading: false,
      });
    ...
    <>
      ...
      {isLoading ? (
        ...
        <>
                    ...
                    <div className="pt-2 pb-4 px-3 mt-2">
                      <div className="d-flex justify-content-between align-items-center mb-2 w-100">
                        <div className="user-account  d-flex align-items-center">
                          ...
                          <div className="user-name px-2">
                            <h6 className="m-0 name">
                              {activeDataObj?.branch_president}
                            </h6>
                            <span className="small email">
                              Branch president
                            </span>
                      ...
                      <div className="my-3">
                        <InfoDivHeader
                          label="ADDRESS"
                          text={activeDataObj.branch_address}
                        />
                      </div>
                      <div className="my-3">
                        <InfoDivHeader
          ...
          <div>
            <CreateBranch refresh={fetchData} addAlert={addAlert} />
            {/* {showEditModal && (
                <EditBranch 
                    branch={activeDataObj}
                    show={showEditModal}
