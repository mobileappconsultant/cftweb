...
const Publications = (): JSX.Element => {
  ...
  return (
    <>
      ...
      <div
        style={{ minWidth: "300px", overflowX: "scroll" }}
        className="d-flex justify-content-between bg-white px-3 pt-3  tab border-bottom over"
      >
        {tabs.map((tab, index) => {
          return (
            <>
              <div
                className={`tab-title d-flex align-items-center  ${
                  ...
                  activeTab === index ? "active-tab-title" : "text-muted"
                } pointer `}
      ...
      <div className="bg-white">{tabs[activeTab].component}</div>
    </>
  );
};
