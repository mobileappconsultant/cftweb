...
const Roles = (): JSX.Element => {
  ...
  return (
    <>
                          ...
                          {dataArr.map((row: any, index: number) => (
                            ...
                            >
                              ...
                              <TableCell align="left">
                                {capiitalizeFirstLetter(row.name)}
                              </TableCell>
                              <TableCell align="left">
      ...
      {showCreateForm && (
        <>
          <CreateRole close={defaultView} addAlert={addAlert} />
        </>
      )}

      {showEditForm && (
        <>
          <EditRole close={defaultView} addAlert={addAlert} roleId={activeId} />
        </>
      )}

      {showViewSingleRole && (
        <>
          <ViewRole close={defaultView} addAlert={addAlert} roleId={activeId} />
        </>
      )}
    </>
  );
