...
import { CREATE_ROLE, EDIT_MESSAGE } from 'GraphQl/Mutations';
...
const CreateRole = (props:any) => {
    ...
    const [createNewRole, loadingParams] = useMutation(CREATE_ROLE); 
    ...
    const fetchData = async() => {
        try {
            ...
            if(data){
               ...
               const groupByModule = groupPermissions('module');
    ...
    const submit = async (e : React.SyntheticEvent<Element, Event>) => {
        ...
        try {
            ...
            if(validate){
                ...
                await createNewRole({variables: payload})
               
               // refreshForm();
                props.addAlert(processAlertSuccess('Role created successfully'));
                props.close(true);
